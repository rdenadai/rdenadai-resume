...
urlpatterns = [
    ...
    url(r'^search/(?P<page>\d{1,3})/(?P<slug>[^\.]+).html', blog.views.search_post, name='search_blog_post'),
    url(r'^search/(?P<slug>[^\.]+).html', blog.views.search_post, name='search_blog_post'),

    url(r'^category/(?P<page>\d{1,3})/(?P<slug>[^\.]+).html', blog.views.view_category, name='view_blog_category'),
